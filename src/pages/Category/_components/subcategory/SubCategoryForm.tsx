...
const SubCategoryForm = ({
  ...
  const schema = z.object({
    name: z
      .string({ required_error: t('Sub-Category Name is required') })
      .min(1, t('Sub-Category Name is required')),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className='grid max-h-[500px] grid-cols-1 gap-6 overflow-y-auto p-2 md:grid-cols-2'>
          ...
          <CustomInput
            fieldName='nameAr'
            label={t('Sub-Category Name Arabic')}
            placeholder={t('Enter Sub-Category Name in Arabic')}
            optional
          />

          <CustomTextarea
            fieldName='description'
            label={t('Sub-Category Description')}
          ...
          <CustomTextarea
            ...
            label={t('Sub-Category Description Arabic')}
            placeholder={t('Enter Sub-Category Description in Arabic')}
            className='md:col-span-2'
            optional
          />
        </div>
